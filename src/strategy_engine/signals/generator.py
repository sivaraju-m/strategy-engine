...
class SignalGenerator:
    ...
    async def generate_signals(self, strategy_name: str, symbol: str, 
        ...
        try:
            ...
            logger.debug(f"Generated {len(signals)} signals for {strategy_name}:{symbol}")
            return signals
...
def generate_signals(config_path: str, universe: str, date: Optional[str] = None) -> None:
    """
