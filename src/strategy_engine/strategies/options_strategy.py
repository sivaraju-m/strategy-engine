...
class OptionsStrategy(BaseStrategy):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        logger.info(
            f"Initialized Options Strategy with vol_threshold={volatility_threshold}, "
    ...
    def calculate_indicators(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if len(returns) >= 252:
                ...
                current_vol_rank = (
                    np.sum(np.array(vol_history) < volatility_20d) / len(vol_history)
                ) * 100
            else:
    ...
    def _should_write_covered_call(self, data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            return (
                ...
                and iv_rank > self.iv_percentile_threshold
                and 40 < rsi < 80  # Not oversold or extremely overbought
                and 0.98 <= price_vs_sma <= 1.05  # Near 20-day SMA
            )
    ...
    def _should_buy_protective_put(self, data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            return (
                volatility > self.volatility_threshold * 1.5  # Higher volatility
                and (rsi < 30)  # Oversold
                and current_price < sma_20  # Below trend
            )
    ...
    def _should_write_cash_secured_put(self, data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            return (
                ...
                and iv_rank > self.iv_percentile_threshold
                and rsi < 40  # Oversold
                and current_price > sma_50  # Long-term uptrend
            )
