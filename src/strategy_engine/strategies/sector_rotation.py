...
class SectorRotationStrategy(BaseStrategy):
    ...
    def calculate_sector_performance(self, data: pd.DataFrame) -> Dict[str, Dict[str, float]]:
        """
    ...
    def rank_sectors(self, sector_performance: Dict[str, Dict[str, float]]) -> List[Tuple[str, float]]:
        """
                            ...
                            if confidence >= self.min_confidence:
                                signal = TradingSignal(
                                    ...
                                    risk_metrics={
                                        'sector': sector,
                                        'sector_score': score,
                                        'sector_rank': sector_rankings.index((sector, score)) + 1
                                    },
                                    position_size=1.0 / len(symbols),  # Equal weight within sector
