    ...
    def __init__(self, config: dict[str, Any]):
        ...
        self.mock_news_data = {
            "RELIANCE.NS": [
                ...
                {
                    "headline": "RIL announces major expansion in renewable energy",
                    "sentiment": 0.7,
                },
            ],
            "TCS.NS": [
                {
                    "headline": "TCS beats earnings estimates with strong digital growth",
                    "sentiment": 0.9,
                },
                {
                    "headline": "Tata Consultancy Services wins major client contract",
                    "sentiment": 0.6,
                },
            ],
            "HDFCBANK.NS": [
                {
                    "headline": "HDFC Bank faces regulatory concerns over lending practices",
                    "sentiment": -0.6,
                },
                {
                    "headline": "Banking sector outlook remains challenging",
                    "sentiment": -0.4,
                },
            ],
            "ICICIBANK.NS": [
                {
                    "headline": "ICICI Bank reports healthy loan growth and improved asset quality",
                    "sentiment": 0.7,
                },
                {
                    "headline": "Private banks show resilience amid market volatility",
                    "sentiment": 0.5,
                },
            ],
            "INFY.NS": [
                {
                    "headline": "Infosys guidance revision raises concerns about IT sector",
                    "sentiment": -0.5,
                },
                {
                    "headline": "Tech services demand softening in key markets",
                    "sentiment": -0.3,
                },
            ],
        }
